  ...
  return {
    ...
    execute: function () {
      ...
      _export("CamCtrl", CamCtrl = (_dec = ccclass('CamCtrl'), _dec2 = property(MeshRenderer), _dec(_class = (_class2 = class CamCtrl extends Component {
        ...
        start() {
          var renderTex = new RenderTexture(); //渲染贴图
          ...
          var cameraComp = this.getComponent(Camera); //获取摄像机

          cameraComp.targetTexture = renderTex; //设置目标贴图

          var pass = this.target.material.passes[0]; //设置pass

          var defines = _extends({
            SAMPLE_FROM_RT: true
          }, pass.defines);

          var renderMat = new Material(); //材质
...
//# sourceMappingURL=f7310c475160f73ebd3408f55dea83762db1a773.js.map